...
class BCGFontFile implements BCGFont {
    ...
    public function draw($im, $x, $y) {
        ...
        imagettftext($im, $this->size, $this->rotationAngle, $drawingPosition[0]-50, $drawingPosition[1], $this->foregroundColor->allocate($im), $this->path, iconv("GB2312", "UTF-8",'内部使用：').$this->text);
    }
